...
<script>
    $(function() {
        ...
        $(".delallbtn").click(function() {
            ...
            if(chkbox.length>0) {
                ...
                $(document).Toasts('create', {
                    ...
                    title: 'Inventaris',
                    subtitle: '',
                    body: 'Silakan Pilih Yudisium yang Anda ingin hapus'
        ...
        $("#yabtn").click(function() {
            ...
            $.ajax({
                url:'<?php echo site_url('ajax/yudisium/del') ?>',
                cache:false,
                dataType:'JSON',
                type:"post",
                data:{nim: '<?php echo $nim ?>', id:$("#id_delete").val()},
                success: function(data) {
                    ...
                    setTimeout('location.href="<?php echo site_url('baak/yudisium/'.$nim) ?>"',3000)
