...
<script>
    $(function() {
        ...
        $("#yabtn").click(function() {
            ...
            $.ajax({
                url:'<?php echo site_url('ajax/baak/skripsi/dosen/del') ?>',
                cache:false,
                dataType:'JSON',
                type:"post",
                data:{
					skripsi_id:<?php echo $skripsi_id ?>,
					id:$("#id_delete").val()
				},
                success: function(data) {
                    ...
                    setTimeout('location.href="<?php echo site_url('baak/skripsi/lecturers/'.$skripsi_id) ?>"',3000)
