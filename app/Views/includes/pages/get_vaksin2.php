...
<script>
    $(function() {
        ...
        $(".delallbtn").click(function() {
            ...
            if(chkbox.length>0) {
                ...
                $(document).Toasts('create', {
                    ...
                    subtitle: '',
                    body: 'Silakan Pilih Vaksin yang Anda ingin hapus'
        ...
        $("#yabtn").click(function() {
            ...
            var tmp = $("#id_delete").val();
            var p = tmp.split("##");
            $.ajax({
                url:'<?php echo site_url('ajax/faskesvaksin/del') ?>',
                cache:false,
                dataType:'JSON',
                type:"post",
                data:{faskes_id:p[0],id:p[1]},
                success: function(data) {
                    ...
                    //  setTimeout('location.href="<?php echo site_url('info/vaksin/list/'.$faskes_id) ?>"',3000)
