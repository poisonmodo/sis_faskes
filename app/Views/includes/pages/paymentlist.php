...
<script>
    $(function() {
        ...
        $(".delallbtn").click(function() {
            ...
            if(chkbox.length>0) {
                ...
                $(document).Toasts('create', {
                    ...
                    subtitle: '',
                    body: 'Silakan Pilih Pembayaran yang Anda ingin hapus'
        ...
        $("#yabtn").click(function() {
            ...
            $.ajax({
                url:'<?php echo site_url('ajax/payment/del') ?>',
                cache:false,
                dataType:'JSON',
                type:"post",
                ...
                success: function(data) {
                    ...
                    setTimeout('location.href="<?php echo site_url('baak/payment/'.$skripsi_id) ?>"',3000)
