                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        ...
                        <?php   $err = session()->getFlashdata('errors'); 
                                ...
                                if(!isset($msg)) { ?>
                                <form method="post" action="<?php echo site_url('master/city/add') ?>">
...
<?php if($provlist) { 
	    foreach($provlist as $prov) { ?>
											<option value="<?php echo $prov->id ?>" <?php echo ($prov->id==set_value('province_id'))?"selected='selected'":"" ?>><?php echo $prov->province ?></option>
<?php 	}
	  } ?>		
										</select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="city" class="form-control <?php echo (isset($err["city"])) ? "is-invalid" : "" ?>" id="city" placeholder="Silakan isi Nama Kota" value="<?php echo set_value('city','') ?>">
                                        <?php echo (isset($err["city"])) ? '<span class="error-invalid-feedback">' . $err["city"] . '</span>' : "" ?>
                                    </div>
                                   
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary" name="addbtn" id="addbtn" value="add">Tambah city</button>
