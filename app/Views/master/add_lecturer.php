                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        ...
                        <?php   $err = session()->getFlashdata('errors'); 
                                ...
                                if(!isset($msg)) { ?>
                                <form method="post" action="<?php echo site_url('master/lecturers/add') ?>">
                                    <div class="form-group">
                                        <label for="nik">NIK <span class="required">*</span></label>
                                        <input type="text" name="nik" class="form-control <?php echo (isset($err["nik"])) ? "is-invalid" : "" ?>" id="nik" placeholder="Silakan isi nik" value="<?php echo set_value('nik','') ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_dosen" class="form-control <?php echo (isset($err["nama_dosen"])) ? "is-invalid" : "" ?>" id="nama_dosen" placeholder="Silakan isi Nama Dosen" value="<?php echo set_value('nama_dosen','') ?>">
