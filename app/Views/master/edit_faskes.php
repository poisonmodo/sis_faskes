                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Edit Faskes</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <p class="card-text">
                        <?php   $err = session()->getFlashdata('errors'); 
                                ...
                                if(!isset($msg)) { ?>
                                <form method="post" action="<?php echo site_url('master/faskes/edit/'.$id) ?>">
                                <div class="form-group">
                                        ...
                                        <select class="form-control" name="faskes_type" id="faskes_type">
                                            ...
                                            <option value="1" <?php echo (1==$faskes->faskes_type)?"selected='selected'":"" ?>>Puskesmas</option>
                                            <option value="2" <?php echo (2==$faskes->faskes_type)?"selected='selected'":"" ?>>Rumah Sakit</option>
                                            <option value="3" <?php echo (3==$faskes->faskes_type)?"selected='selected'":"" ?>>Klinik</option>	
										</select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="faskes_name" class="form-control <?php echo (isset($err["faskes_name"])) ? "is-invalid" : "" ?>" id="faskes_name" placeholder="Silakan isi Nama Faskes" value="<?php echo $faskes->faskes_name ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="faskes_address" class="form-control <?php echo (isset($err["faskes_address"])) ? "is-invalid" : "" ?>" id="faskes_address" placeholder="Silakan isi Alamat Faskes"><?php echo $faskes->faskes_address ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="faskes_phone" class="form-control <?php echo (isset($err["faskes_phone"])) ? "is-invalid" : "" ?>" id="faskes_phone" placeholder="Silakan isi No Telepon Faskes" value="<?php echo $faskes->faskes_phone ?>">
...
<?php if($citylist) { 
	    foreach($citylist as $city) { ?>
											<option value="<?php echo $city->id ?>" <?php echo ($city->id==$faskes->city_id)?"selected='selected'":"" ?>><?php echo $city->city ?></option>
<?php 	}
	  } ?>		
										</select>
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary" name="editbtn" id="editbtn" value="update">Update Faskes</button>
