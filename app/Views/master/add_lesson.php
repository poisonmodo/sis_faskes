                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        ...
                        <?php   $err = session()->getFlashdata('errors'); 
                                ...
                                if(!isset($msg)) { ?>
                                <form method="post" action="<?php echo site_url('master/lesson/add') ?>">
                                    <div class="form-group">
                                        <label for="kode_matakuliah">Kode Mata Kuliah <span class="required">*</span></label>
                                        <input type="text" name="kode_matakuliah" class="form-control <?php echo (isset($err["kode_matakuliah"])) ? "is-invalid" : "" ?>" id="kode_matakuliah" placeholder="Silakan isi Kode Mata Kuliah" value="<?php echo set_value('kode_matakuliah','') ?>">
									...
									<div class="form-group">
                                        ...
                                        <input type="text" name="nama_matakuliah" class="form-control <?php echo (isset($err["nama_matakuliah"])) ? "is-invalid" : "" ?>" id="nama_matakuliah" placeholder="Silakan isi Nama Mata Kuliah" value="<?php echo set_value('nama_matakuliah','') ?>">
									...
									<div class="form-group">
                                        ...
                                        <input type="text" name="sks" class="form-control <?php echo (isset($err["sks"])) ? "is-invalid" : "" ?>" id="sks" placeholder="Silakan isi SKS" value="<?php echo set_value('sks','') ?>">
                                        <?php echo (isset($err["sks"])) ? '<span class="error-invalid-feedback">' . $err["sks"] . '</span>' : "" ?>
                                    </div>
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary" name="addbtn" id="addbtn" value="add">Tambah Mata Kuliah</button>
                                        <p>
