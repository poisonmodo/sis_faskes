                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        ...
                        <?php   $err = session()->getFlashdata('errors'); 
                                ...
                                if(!isset($msg)) { ?>
                                <form method="post" action="<?php echo site_url('baak/payment/add/'.$skripsi_id) ?>" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="tgl_bayar" data-target-input="nearest">
											<input type="text" class="form-control datetimepicker-input" data-target="#tglbayar" name="tgl_bayar" />
...
<?php 	}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="biaya" id="biaya" value="<?php echo set_value('biaya') ?>" >
                                    </div>
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary" name="addbtn" id="addbtn" value="add">Tambah Pembayaran</button>
