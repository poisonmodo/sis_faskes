                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Edit Ijazah</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <p class="card-text">
                        <?php   $err = session()->getFlashdata('errors'); 
                                ...
                                if(!isset($msg)) { ?>
                                <form method="post" action="<?php echo site_url('baak/ijazah/edit/'.$nim."/".$id) ?>" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="tanggal_yudisium" data-target-input="nearest">
											<input type="text" class="form-control datetimepicker-input" data-target="#tglbuat" name="tanggal_yudisium" value="<?php echo $ijazah->tanggal_yudisium ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="tanggal_ijazah" data-target-input="nearest">
											<input type="text" class="form-control datetimepicker-input" data-target="#tglbuat" name="tanggal_ijazah" value="<?php echo $ijazah->tanggal_ijazah ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_ijazah" class="form-control <?php echo (isset($err["no_ijazah"])) ? "is-invalid" : "" ?>" id="no_ijazah" placeholder="Silakan isi Nama no_ijazah" value="<?php echo $ijazah->no_ijazah ?>">
                                        <?php echo (isset($err["no_ijazah"])) ? '<span class="error-invalid-feedback">' . $err["no_ijazah"] . '</span>' : "" ?>
                                    </div>
                                    <div class="form-group">    
                                        <label for="photo">photo</label><br>
<?php                         $path=FCPATH."/images/ijazah";
                              $imgpath = $path."/".$ijazah->nim; 
                              $imgurl = site_url("images/ijazah/".$ijazah->nim."/".$ijazah->filename);      
                              if(file_exists($imgpath."/".$ijazah->filename)) { ?>
                        ...
                        <?php }  ?>                                                   
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary" name="editbtn" id="editbtn" value="update">Update Ijazah</button>
