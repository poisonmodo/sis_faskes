                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        ...
                        <?php   $err = session()->getFlashdata('errors'); 
                                ...
                                if(!isset($msg)) { ?>
                                <form method="post" action="<?php echo site_url('baak/checklist/edit/'.$skripsi_id.'/'.$id) ?>" enctype="multipart/form-data">
...
<?php if($paramlist) { 
		foreach($paramlist as $param) { ?>
											<option value="<?php echo $param->id ?>" <?php echo ($param->id==$detail->parameter_id)?"selected='selected'":"" ?>><?php echo $param->param_name ?></option>
<?php 	}
	  } ?>		
										</select>
...
<?php                                   $path=FCPATH."/images/documents";
                                        $imgfile=$path."/".$detail->nim."/".$detail->foto;    
                                        $imgurl="images/documents/".$detail->nim."/".$detail->foto;
...
?>                                        
                                        <img src="<?php echo $url ?>" class="preview"><br />
